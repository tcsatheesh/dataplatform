...
def createCompute(ws,clusterName,min_nodes,max_nodes,clusterSku,verbose):
    # choose a name for your cluster
    compute_name = os.environ.get("AML_COMPUTE_CLUSTER_NAME", clusterName)
    ...
    vm_size = os.environ.get("AML_COMPUTE_CLUSTER_SKU", clusterSku)
...
def createEstimator(ws, args, folders):
    ...
    compute_target = createCompute(ws,args.clusterName,args.minNodes,args.maxNodes, args.clusterSku, args.verbose)
